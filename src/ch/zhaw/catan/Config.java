...
public class Config {
    ...
    // range of x coordinates for building
    public static final int X_MIN = 2;
    public static final int X_MAX = 12;
    ...
    public enum Faction {
      ...
      /**
       * Find the faction that corresponds to the given name
       *
       * @param data The name of the faction e.g. 'yy'
       * @return The faction that corresponds to the given name
       */
        public static Faction findByName(String data) {
            return Arrays.stream(values())
                    .filter(fac -> fac.name.equals(data))
                    .findFirst()
                    .orElseThrow();
        }
    }
    ...
    public enum Resource {
        ...
        /**
         * Find the resource that corresponds to the given name
         *
         * @param data The name of the resource e.g. 'WL'
         * @return The Resource that corresponds to the given name
         */
        public static Resource findByName(String data) {
            return Arrays.stream(values())
                    .filter(res -> res.name.equals(data))
                    .findFirst()
                    .orElseThrow();
        }
